// ISO 3166-1 alpha-2 codes + English names, generated once via Node's
// Intl.DisplayNames (see git history) rather than shipped as a runtime
// dependency or computed on-device — avoids relying on a specific
// Hermes ICU build having full Intl data.
...
// A flag emoji is just two "regional indicator" code points spelling out
// the ISO code (e.g. JP -> 🇯🇵) -- no image assets or dependency needed.
