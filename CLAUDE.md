...
- **The push arc, end to end on iOS (2026-09-03):** a clip inserted as the
  ...
  branch of `routeForNotification`, left unverified when PR #72 merged.
  Note a 200 in `net._http_response` is Expo *accepting* the message, not
  APNs delivering it; those fail separately
